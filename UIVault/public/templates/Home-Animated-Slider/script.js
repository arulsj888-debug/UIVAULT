...
const SLIDES = [
  { name: "Fjord",  color: "#6B5B50", image: "https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?w=600&q=80" },
  { name: "Aether", color: "#B8B5A4", image: "https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=600&q=80" },
  { name: "Onyx",   color: "#8BA8A8", image: "https://images.unsplash.com/photo-1588880331179-bc9b93a8cb5e?w=600&q=80" },
  { name: "Birch",  color: "#B5A882", image: "https://images.unsplash.com/photo-1600585154363-67eb9e2e2099?w=600&q=80" }
];
...
class Slider {
  ...
  go(direction) {
    ...
    master.to(this.el, { backgroundColor: SLIDES[nextIdx].color, duration: this.reducedMotion ? 0.01 : 1.2, ease: "power2.inOut" }, 0);
